...
public:
    void testAccountLines()
    {
        ...
        }
        {
            ...
            BEAST_EXPECT(line[jss::no_mtchain].asBool() == true);
        ...
        }
        {
            ...
            BEAST_EXPECT(lineA[jss::no_mtchain_peer].asBool() == true);
    ...
    void testAccountLines2()
    {
        ...
        Env env(*this);
        {
            ...
            BEAST_EXPECT(lines.isMember(jss::mtchainrpc) && lines[jss::mtchainrpc] == "2.0");
        }
        {
            // account_lines with no account.
            auto const lines = env.rpc ("json2", "{ "
        ...
        [this, &env](Account const& account, LedgerInfo const& info, int count)
        {
            ...
            BEAST_EXPECT(linesSeq.isMember(jss::mtchainrpc) && linesSeq[jss::mtchainrpc] == "2.0");
            ...
            BEAST_EXPECT(linesHash.isMember(jss::mtchainrpc) && linesHash[jss::mtchainrpc] == "2.0");
        ...
        }
        {
            ...
            BEAST_EXPECT(linesA.isMember(jss::mtchainrpc) && linesA[jss::mtchainrpc] == "2.0");
            ...
            BEAST_EXPECT(linesB.isMember(jss::mtchainrpc) && linesB[jss::mtchainrpc] == "2.0");
            ...
            BEAST_EXPECT(linesC.isMember(jss::mtchainrpc) && linesC[jss::mtchainrpc] == "2.0");
            ...
            BEAST_EXPECT(linesD.isMember(jss::mtchainrpc) && linesD[jss::mtchainrpc] == "2.0");
    ...
    void testAccountLineDelete2()
    {
        ...
        BEAST_EXPECT(linesBeg.isMember(jss::mtchainrpc) && linesBeg[jss::mtchainrpc] == "2.0");
        ...
        BEAST_EXPECT(linesEnd.isMember(jss::mtchainrpc) && linesEnd[jss::mtchainrpc] == "2.0");
