...
class Offer_test : public beast::unit_test::suite
{
    ...
    ledgerEntryState(jtx::Env & env, jtx::Account const& acct_a, jtx::Account const & acct_b, std::string const& currency)
    {
        ...
        jvParams[jss::mtchain_state][jss::currency] = currency;
        jvParams[jss::mtchain_state][jss::accounts] = Json::arrayValue;
        jvParams[jss::mtchain_state][jss::accounts].append(acct_a.human());
        jvParams[jss::mtchain_state][jss::accounts].append(acct_b.human());
...
public:
    ...
    testGatewayCrossCurrency()
    {
        ...
        if (wsc->version() == 2)
        {
            ...
            BEAST_EXPECT(jrr.isMember(jss::mtchainrpc) && jrr[jss::mtchainrpc] == "2.0");
