...
#
#    Permission to use, copy, modify, and/or distribute this software for anys
#
...
parser = argparse.ArgumentParser(
    description='Test.py - run mtchain tests'
)
...
def run_tests(args):
    failed = []
    if IS_WINDOWS:
        binary_re = re.compile(r'build\\([^\\]+)\\mtchaind.exe')
    else:
        binary_re = re.compile(r'build/([^/]+)/mtchaind')
